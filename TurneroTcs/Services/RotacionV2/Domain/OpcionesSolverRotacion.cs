...
/// <summary>
/// Define cuan fuerte debe ser la preferencia del solver por mantener el mismo codigo de turno
/// en dias consecutivos trabajados por un mismo empleado, evitando secuencias muy dispersas.
/// </summary>
public enum NivelAgruparTiposTurnoConsecutivos
{
    /// <summary>No agrega una penalizacion extra por cambios de codigo de turno entre dias consecutivos.</summary>
    NoUsar,

    /// <summary>Aplica una preferencia suave por mantener el mismo codigo de turno en dias consecutivos.</summary>
    Bajo,

    /// <summary>Aplica una preferencia intermedia por reducir la dispersion entre tipos de turno consecutivos.</summary>
    Medio,

    /// <summary>Aplica la preferencia mas fuerte por agrupar secuencias consecutivas en el mismo codigo de turno.</summary>
    Alto
}
...
public sealed record OpcionesSolverRotacion
{
    ...
    /// <summary>Nivel de prioridad con que se intenta mantener el mismo codigo de turno en dias consecutivos trabajados.</summary>
