...
public static class ConstructorObjetivoRotacion
{
    ...
    public static void Aplicar(ContextoModeloCp contexto)
    {
        ...
        if (ObjetivoMinimizarDispersionTiposTurnoConsecutivos.CrearPenalizacion(contexto) is IntVar penalizacionDispersionTiposTurno)
        {
            variablesObjetivo.Add(penalizacionDispersionTiposTurno);
            pesos.Add(ResolverPesoAgruparTiposTurnoConsecutivos(contexto));
        }
    ...
    private static long ResolverPesoAgruparTiposTurnoConsecutivos(ContextoModeloCp contexto)
    {
        return contexto.Problema.Reglas.Configurables.NivelAgruparTiposTurnoConsecutivos switch
        {
            Domain.NivelAgruparTiposTurnoConsecutivos.Alto => 1800,
            Domain.NivelAgruparTiposTurnoConsecutivos.Medio => 700,
            Domain.NivelAgruparTiposTurnoConsecutivos.Bajo => 220,
            _ => 0
        };
    }
}
