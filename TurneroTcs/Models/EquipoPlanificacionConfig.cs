...
public class EquipoPlanificacionConfig
{
    ...
    /// <summary>
    /// Cuando <see langword="true"/>, los turnos nocturnos por semana pueden distribuirse en secuencias
    /// de hasta 3 consecutivas seguidas de al menos un dia de descanso antes de reiniciar el conteo,
    /// sin rebasar el maximo semanal configurado.
    /// Cuando <see langword="false"/> (predeterminado), se aplica la restriccion simple de maximo semanal.
    /// </summary>
    [Column("nocturnos_consecutivos")]
    public bool NocturnosConsecutivos { get; set; }
}
