...
public interface IPlanificacionService
{
    ...
    Task<Result> SaveEquipoPlanificacionConfigAsync(string equipoId, int? maximoSlotsFinSemanaPorMes, int? maximoTurnosNocturnosPorMes, int? maximoTurnosNocturnosPorSemana, bool? nocturnosConsecutivos = null);
